...
const TOOLS = [
  { name: 'Gmail', status: 'Ready', colorClass: 'icon-purple', svg: (
  ...
  { name: 'Calendar', status: 'Active', colorClass: 'icon-teal', svg: (
  ...
  { name: 'CSV Tool', status: 'Ready', colorClass: 'icon-blue', svg: (
      ...
      <div className="side-scroll-area">
        ...
        <div className="side-section">
          ...
          <div className="side-tools-list">
            {TOOLS.map((tool, i) => (
              <div key={i} className="premium-tool-card">
        ...
        <div className="side-section">
          ...
          <div className="quick-commands-grid">
            {COMMANDS.map((cmd, i) => (
              <button key={i} className="command-chip">
                {cmd}
              </button>
            ))}
          </div>
